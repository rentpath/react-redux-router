...
describe('reducer', function () {
  describe(_const.CHANGE_LOCATION, function () {
    ...
    it('builds a partial href', function () {
      var state = (0, _reducer2.default)(_reducer.initial, action);
      (0, _chai.expect)(state.location.href).to.equal('/foo');
    });

    it('builds a complete href', function () {
      var state = (0, _reducer2.default)(_reducer.initial, (0, _extends3.default)({}, action, {
        location: {
          protocol: 'http:',
          hostname: 'foo.com',
          pathname: '/bar'
      ...
      (0, _chai.expect)(state.location.href).to.equal('http://foo.com/bar');
    });
