...
var _globalResolves = require("./globalResolves");
  ...
  return new Promise(function ($return, $error) {
    ...
    branches.forEach(function (branch, index) {
      var _branch$route = branch.route,
          ...
          rest = (0, _objectWithoutProperties2.default)(_branch$route, ["action", "resolve", "component"]);
    ...
    sanitized = (0, _utils.sanitize)(route); // create container for middleware updates
    ...
    runResolver = function runResolver(resolver, index) {
      ...
      promises.push(response.then(function () {
        ...
        var action = _ref.action,
            ...
            props = (0, _objectWithoutProperties2.default)(_ref, ["action", "component"]);
    ...
    globalResolves = (0, _globalResolves.getGlobalResolves)();
    ...
    function $If_1() {
      ...
      function $If_2() {
        ...
        function $If_3() {
          ...
          sanitized = (0, _utils.sanitize)(route); // we don't want these in the state
